...
#define WM_SIZEBAR_CLOSE						(WM_USER + 0X1009)		//add log 
...
class DLLPORT CSCBDockBar : public CDockBar
{
...
class  DLLPORT CSizingControlBar : public baseCSizingControlBar
{
...
class DLLPORT CSCBDockContext : public CDockContext
{
public:
// Construction
...
class DLLPORT CSCBMiniDockFrameWnd : public baseCSCBMiniDockFrameWnd
{
